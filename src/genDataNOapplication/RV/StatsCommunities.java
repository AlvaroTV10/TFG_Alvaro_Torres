...
public static int StatsCommunities()
{
	...
	//Álvaro edited
	like1v.add((String)"music artist");	like2v.add((String)"music artist");	like3v.add((String)"music artist");
	like1v.add((String)"drink");		like2v.add((String)"drink");		like3v.add((String)"drink");
	like1v.add((String)"tv show");		like2v.add((String)"tv show");		like3v.add((String)"tv show");
	like1v.add((String)"sports");			like2v.add((String)"sports");		like3v.add((String)"sports");
	like1v.add((String)"animals");			like2v.add((String)"animals");		like3v.add((String)"animals");
	like1v.add((String)"computer games");			like2v.add((String)"computer games");		like3v.add((String)"computer games");
	like1v.add((String)"news");			like2v.add((String)"news");		like3v.add((String)"news");
	like1v.add((String)"food");			like2v.add((String)"food");		like3v.add((String)"food");
	like1v.add((String)"travel");			like2v.add((String)"travel");		like3v.add((String)"travel");
	like1v.add((String)"fashion");			like2v.add((String)"fashion");		like3v.add((String)"fashion");
	like1v.add((String)"cars");			like2v.add((String)"cars");		like3v.add((String)"cars");
	like1v.add((String)"jokes");			like2v.add((String)"jokes");		like3v.add((String)"jokes");
	like1v.add((String)"technology");			like2v.add((String)"technology");		like3v.add((String)"technology");
	like1v.add((String)"watch");			like2v.add((String)"watch");		like3v.add((String)"watch");
	like1v.add((String)"jewellery");			like2v.add((String)"jewellery");		like3v.add((String)"jewellery");
	like1v.add((String)"dance");			like2v.add((String)"dance");		like3v.add((String)"dance");
	like1v.add((String)"physical fitness");			like2v.add((String)"physical fitness");		like3v.add((String)"physical fitness");
	like1v.add((String)"architecture");			like2v.add((String)"architecture");		like3v.add((String)"architecture");
	like1v.add((String)"interior design");			like2v.add((String)"interior design");		like3v.add((String)"interior design");
	like1v.add((String)"culture");			like2v.add((String)"culture");		like3v.add((String)"culture");
