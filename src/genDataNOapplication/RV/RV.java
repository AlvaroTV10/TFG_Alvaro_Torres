...
public static Map<Integer, Integer> num_pub_by_time = new HashMap<Integer, Integer>();
public static List<Publication> publications_RV = new LinkedList <Publication> ();
...
public int RVp(ConfigurationModel configuration) throws Exception 
{
...
public static int writeData(BufferedWriter output, BufferedWriter outputg, BufferedWriter outputs1){
	...
	int like1_sports = 0, like1_musicartist = 0,	like1_drink = 0, like1_tvshow = 0;
	int like2_sports = 0, like2_musicartist = 0,	like2_drink = 0, like2_tvshow = 0;
	int like3_sports = 0, like3_musicartist = 0,	like3_drink = 0, like3_tvshow = 0;

	int like1_animals = 0, like1_computergames = 0,	like1_news = 0, like1_food = 0;
	int like2_animals = 0, like2_computergames = 0,	like2_news = 0, like2_food = 0;
	int like3_animals = 0, like3_computergames = 0,	like3_news = 0, like3_food = 0;
	
	int like1_travel = 0, like1_fashion = 0,	like1_cars = 0, like1_jokes = 0;
	int like2_travel = 0, like2_fashion = 0,	like2_cars = 0, like2_jokes = 0;
	int like3_travel = 0, like3_fashion = 0,	like3_cars = 0, like3_jokes = 0;
	
	int like1_technology = 0, like1_watch = 0,	like1_jewellery = 0, like1_dance = 0;
	int like2_technology = 0, like2_watch = 0,	like2_jewellery = 0, like2_dance = 0;
	int like3_technology = 0, like3_watch = 0,	like3_jewellery = 0, like3_dance = 0;
	
	int like1_physicalfitness = 0, like1_architecture = 0,	like1_interiordesign = 0, like1_culture = 0;
	int like2_physicalfitness = 0, like2_architecture = 0,	like2_interiordesign = 0, like2_culture = 0;
	int like3_physicalfitness = 0, like3_architecture = 0,	like3_interiordesign = 0, like3_culture = 0;
	...
	while (en1.hasMoreElements()){
		...
		if (like1.equals("music artist")) like1_musicartist = like1_musicartist + 1;
		else if (like1.equals("drink")) like1_drink = like1_drink + 1;
		else if (like1.equals("tv show")) like1_tvshow = like1_tvshow + 1;
		else if (like1.equals("sports")) like1_sports = like1_sports + 1;
		else if (like1.equals("animals")) like1_animals = like1_animals + 1;
		else if (like1.equals("computer games")) like1_computergames = like1_computergames + 1;
		else if (like1.equals("news")) like1_news = like1_news + 1;
		else if (like1.equals("food")) like1_food = like1_food + 1;
		else if (like1.equals("travel")) like1_travel = like1_travel + 1;
		else if (like1.equals("fashion")) like1_fashion = like1_fashion + 1;
		else if (like1.equals("cars")) like1_cars = like1_cars + 1;
		else if (like1.equals("jokes")) like1_jokes = like1_jokes + 1;
		else if (like1.equals("technology")) like1_technology = like1_technology + 1;
		else if (like1.equals("watch")) like1_watch = like1_watch + 1;
		else if (like1.equals("jewellery")) like1_jewellery = like1_jewellery + 1;
		else if (like1.equals("dance")) like1_dance = like1_dance + 1;
		else if (like1.equals("physical fitness")) like1_physicalfitness = like1_physicalfitness + 1;
		else if (like1.equals("architecture")) like1_architecture = like1_architecture + 1;
		else if (like1.equals("interior design")) like1_interiordesign = like1_interiordesign + 1;
		else if (like1.equals("culture")) like1_culture = like1_culture + 1;

		if (like2.equals("music artist")) like2_musicartist = like2_musicartist + 1;
		else if (like2.equals("drink")) like2_drink = like2_drink + 1;
		else if (like2.equals("tv show")) like2_tvshow = like2_tvshow + 1;
		else if (like2.equals("sports")) like2_sports = like2_sports + 1;
		else if (like2.equals("animals")) like2_animals = like2_animals + 1;
		else if (like2.equals("computer games")) like2_computergames = like2_computergames + 1;
		else if (like2.equals("news")) like2_news = like2_news + 1;
		else if (like2.equals("food")) like2_food = like2_food + 1;
		else if (like2.equals("travel")) like2_travel = like2_travel + 1;
		else if (like2.equals("fashion")) like2_fashion = like2_fashion + 1;
		else if (like2.equals("cars")) like2_cars = like2_cars + 1;
		else if (like2.equals("jokes")) like2_jokes = like2_jokes + 1;
		else if (like2.equals("technology")) like2_technology = like2_technology + 1;
		else if (like2.equals("watch")) like2_watch = like2_watch + 1;
		else if (like2.equals("jewellery")) like2_jewellery = like2_jewellery + 1;
		else if (like2.equals("dance")) like2_dance = like2_dance + 1;
		else if (like2.equals("physical fitness")) like2_physicalfitness = like2_physicalfitness + 1;
		else if (like2.equals("architecture")) like2_architecture = like2_architecture + 1;
		else if (like2.equals("interior design")) like2_interiordesign = like2_interiordesign + 1;
		else if (like2.equals("culture")) like2_culture = like2_culture + 1;

		if (like3.equals("music artist")) like3_musicartist = like3_musicartist + 1;
		else if (like3.equals("drink")) like3_drink = like3_drink + 1;
		else if (like3.equals("tv show")) like3_tvshow = like3_tvshow + 1;
		else if (like3.equals("sports")) like3_sports = like3_sports + 1;
		else if (like3.equals("animals")) like3_animals = like3_animals + 1;
		else if (like3.equals("computer games")) like3_computergames = like3_computergames + 1;
		else if (like3.equals("news")) like3_news = like3_news + 1;
		else if (like3.equals("food")) like3_food = like3_food + 1;
		else if (like3.equals("travel")) like3_travel = like3_travel + 1;
		else if (like3.equals("fashion")) like3_fashion = like3_fashion + 1;
		else if (like3.equals("cars")) like3_cars = like3_cars + 1;
		else if (like3.equals("jokes")) like3_jokes = like3_jokes + 1;
		else if (like3.equals("technology")) like3_technology = like3_technology + 1;
		else if (like3.equals("watch")) like3_watch = like3_watch + 1;
		else if (like3.equals("jewellery")) like3_jewellery = like3_jewellery + 1;
		else if (like3.equals("dance")) like3_dance = like3_dance + 1;
		else if (like3.equals("physical fitness")) like3_physicalfitness = like3_physicalfitness + 1;
		else if (like3.equals("architecture")) like3_architecture = like3_architecture + 1;
		else if (like3.equals("interior design")) like3_interiordesign = like3_interiordesign + 1;
		else if (like3.equals("culture")) like3_culture = like3_culture + 1;
	...
	outputs1.write("ALL;LIKE1;drink;"+like1_drink); outputs1.newLine();
	outputs1.write("ALL;LIKE1;tv show;"+like1_tvshow); outputs1.newLine();
	outputs1.write("ALL;LIKE1;sports;"+like1_sports); outputs1.newLine();
	outputs1.write("ALL;LIKE1;animals;"+like1_animals); outputs1.newLine();
	outputs1.write("ALL;LIKE1;computer games;"+like1_computergames); outputs1.newLine();
	outputs1.write("ALL;LIKE1;news;"+like1_news); outputs1.newLine();
	outputs1.write("ALL;LIKE1;food;"+like1_food); outputs1.newLine();
	outputs1.write("ALL;LIKE1;travel;"+like1_travel); outputs1.newLine();
	outputs1.write("ALL;LIKE1;fashion;"+like1_fashion); outputs1.newLine();
	outputs1.write("ALL;LIKE1;cars;"+like1_cars); outputs1.newLine();
	outputs1.write("ALL;LIKE1;jokes;"+like1_jokes); outputs1.newLine();
	outputs1.write("ALL;LIKE1;technology;"+like1_technology); outputs1.newLine();
	outputs1.write("ALL;LIKE1;watch;"+like1_watch); outputs1.newLine();
	outputs1.write("ALL;LIKE1;jewellery;"+like1_jewellery); outputs1.newLine();
	outputs1.write("ALL;LIKE1;dance;"+like1_dance); outputs1.newLine();
	outputs1.write("ALL;LIKE1;physical fitness;"+like1_physicalfitness); outputs1.newLine();
	outputs1.write("ALL;LIKE1;architecture;"+like1_architecture); outputs1.newLine();
	outputs1.write("ALL;LIKE1;interior design;"+like1_interiordesign); outputs1.newLine();
	outputs1.write("ALL;LIKE1;culture;"+like1_culture); outputs1.newLine();
	
	
	outputs1.write("ALL;LIKE2;music artist;"+like2_musicartist); outputs1.newLine();
	outputs1.write("ALL;LIKE2;drink;"+like2_drink); outputs1.newLine();
	outputs1.write("ALL;LIKE2;tv show;"+like2_tvshow); outputs1.newLine();
	outputs1.write("ALL;LIKE2;sports;"+like2_sports); outputs1.newLine();
	outputs1.write("ALL;LIKE2;animals;"+like2_animals); outputs1.newLine();
	outputs1.write("ALL;LIKE2;computer games;"+like2_computergames); outputs1.newLine();
	outputs1.write("ALL;LIKE2;news;"+like2_news); outputs1.newLine();
	outputs1.write("ALL;LIKE2;food;"+like2_food); outputs1.newLine();
	outputs1.write("ALL;LIKE2;travel;"+like2_travel); outputs1.newLine();
	outputs1.write("ALL;LIKE2;fashion;"+like2_fashion); outputs1.newLine();
	outputs1.write("ALL;LIKE2;cars;"+like2_cars); outputs1.newLine();
	outputs1.write("ALL;LIKE2;jokes;"+like2_jokes); outputs1.newLine();
	outputs1.write("ALL;LIKE2;technology;"+like2_technology); outputs1.newLine();
	outputs1.write("ALL;LIKE2;watch;"+like2_watch); outputs1.newLine();
	outputs1.write("ALL;LIKE2;jewellery;"+like2_jewellery); outputs1.newLine();
	outputs1.write("ALL;LIKE2;dance;"+like2_dance); outputs1.newLine();
	outputs1.write("ALL;LIKE2;physical fitness;"+like2_physicalfitness); outputs1.newLine();
	outputs1.write("ALL;LIKE2;architecture;"+like2_architecture); outputs1.newLine();
	outputs1.write("ALL;LIKE2;interior design;"+like2_interiordesign); outputs1.newLine();
	outputs1.write("ALL;LIKE2;culture;"+like2_culture); outputs1.newLine();
	
	outputs1.write("ALL;LIKE3;music artist;"+like3_musicartist); outputs1.newLine();
	outputs1.write("ALL;LIKE3;drink;"+like3_drink); outputs1.newLine();
	outputs1.write("ALL;LIKE3;tv show;"+like3_tvshow); outputs1.newLine();
	outputs1.write("ALL;LIKE3;sports;"+like3_sports); outputs1.newLine();
	outputs1.write("ALL;LIKE3;animals;"+like3_animals); outputs1.newLine();
	outputs1.write("ALL;LIKE3;computer games;"+like3_computergames); outputs1.newLine();
	outputs1.write("ALL;LIKE3;news;"+like3_news); outputs1.newLine();
	outputs1.write("ALL;LIKE3;food;"+like3_food); outputs1.newLine();
	outputs1.write("ALL;LIKE3;travel;"+like3_travel); outputs1.newLine();
	outputs1.write("ALL;LIKE3;fashion;"+like3_fashion); outputs1.newLine();
	outputs1.write("ALL;LIKE3;cars;"+like3_cars); outputs1.newLine();
	outputs1.write("ALL;LIKE3;jokes;"+like3_jokes); outputs1.newLine();
	outputs1.write("ALL;LIKE3;technology;"+like3_technology); outputs1.newLine();
	outputs1.write("ALL;LIKE3;watch;"+like3_watch); outputs1.newLine();
	outputs1.write("ALL;LIKE3;jewellery;"+like3_jewellery); outputs1.newLine();
	outputs1.write("ALL;LIKE3;dance;"+like3_dance); outputs1.newLine();
	outputs1.write("ALL;LIKE3;physical fitness;"+like3_physicalfitness); outputs1.newLine();
	outputs1.write("ALL;LIKE3;architecture;"+like3_architecture); outputs1.newLine();
	outputs1.write("ALL;LIKE3;interior design;"+like3_interiordesign); outputs1.newLine();
	outputs1.write("ALL;LIKE3;culture;"+like3_culture); outputs1.newLine();
...
public static int writeData2(BufferedWriter outputs1, BufferedWriter output2){
	...
	while (en2.hasMoreElements()){    // OUTER LOOP COMMUNITIES
		...
		outputs1.write(com1+";LIKE1;drink;"+like1_drink); outputs1.newLine();
		outputs1.write(com1+";LIKE1;tv show;"+like1_tvshow); outputs1.newLine();
		outputs1.write(com1+";LIKE1;sports;"+like1_sports); outputs1.newLine();
		outputs1.write(com1+";LIKE1;animals;"+like1_animals); outputs1.newLine();
		outputs1.write(com1+";LIKE1;computer games;"+like1_computergames); outputs1.newLine();
		outputs1.write(com1+";LIKE1;news;"+like1_news); outputs1.newLine();
		outputs1.write(com1+";LIKE1;food;"+like1_food); outputs1.newLine();
		outputs1.write(com1+";LIKE1;travel;"+like1_travel); outputs1.newLine();
		outputs1.write(com1+";LIKE1;fashion;"+like1_fashion); outputs1.newLine();
		outputs1.write(com1+";LIKE1;cars;"+like1_cars); outputs1.newLine();
		outputs1.write(com1+";LIKE1;jokes;"+like1_jokes); outputs1.newLine();
		outputs1.write(com1+";LIKE1;technology;"+like1_technology); outputs1.newLine();
		outputs1.write(com1+";LIKE1;watch;"+like1_watch); outputs1.newLine();
		outputs1.write(com1+";LIKE1;jewellery;"+like1_jewellery); outputs1.newLine();
		outputs1.write(com1+";LIKE1;dance;"+like1_dance); outputs1.newLine();
		outputs1.write(com1+";LIKE1;physical fitness;"+like1_physicalfitness); outputs1.newLine();
		outputs1.write(com1+";LIKE1;architecture;"+like1_architecture); outputs1.newLine();
		outputs1.write(com1+";LIKE1;interior design;"+like1_interiordesign); outputs1.newLine();
		outputs1.write(com1+";LIKE1;culture;"+like1_culture); outputs1.newLine();
		
		outputs1.write(com1+";LIKE2;music artist;"+like2_musicartist); outputs1.newLine();
		outputs1.write(com1+";LIKE2;drink;"+like2_drink); outputs1.newLine();
		outputs1.write(com1+";LIKE2;tv show;"+like2_tvshow); outputs1.newLine();
		outputs1.write(com1+";LIKE2;sports;"+like2_sports); outputs1.newLine();
		outputs1.write(com1+";LIKE2;animals;"+like2_animals); outputs1.newLine();
		outputs1.write(com1+";LIKE2;computer games;"+like2_computergames); outputs1.newLine();
		outputs1.write(com1+";LIKE2;news;"+like2_news); outputs1.newLine();
		outputs1.write(com1+";LIKE2;food;"+like2_food); outputs1.newLine();
		outputs1.write(com1+";LIKE2;travel;"+like2_travel); outputs1.newLine();
		outputs1.write(com1+";LIKE2;fashion;"+like2_fashion); outputs1.newLine();
		outputs1.write(com1+";LIKE2;cars;"+like2_cars); outputs1.newLine();
		outputs1.write(com1+";LIKE2;jokes;"+like2_jokes); outputs1.newLine();
		outputs1.write(com1+";LIKE2;technology;"+like2_technology); outputs1.newLine();
		outputs1.write(com1+";LIKE2;watch;"+like2_watch); outputs1.newLine();
		outputs1.write(com1+";LIKE2;jewellery;"+like2_jewellery); outputs1.newLine();
		outputs1.write(com1+";LIKE2;dance;"+like2_dance); outputs1.newLine();
		outputs1.write(com1+";LIKE2;physical fitness;"+like2_physicalfitness); outputs1.newLine();
		outputs1.write(com1+";LIKE2;architecture;"+like2_architecture); outputs1.newLine();
		outputs1.write(com1+";LIKE2;interior design;"+like2_interiordesign); outputs1.newLine();
		outputs1.write(com1+";LIKE2;culture;"+like2_culture); outputs1.newLine();
		
		outputs1.write(com1+";LIKE3;music artist;"+like3_musicartist); outputs1.newLine();
		outputs1.write(com1+";LIKE3;drink;"+like3_drink); outputs1.newLine();
		outputs1.write(com1+";LIKE3;tv show;"+like3_tvshow); outputs1.newLine();
		outputs1.write(com1+";LIKE3;sports;"+like3_sports); outputs1.newLine();
		outputs1.write(com1+";LIKE3;animals;"+like3_animals); outputs1.newLine();
		outputs1.write(com1+";LIKE3;computer games;"+like3_computergames); outputs1.newLine();
		outputs1.write(com1+";LIKE3;news;"+like3_news); outputs1.newLine();
		outputs1.write(com1+";LIKE3;food;"+like3_food); outputs1.newLine();
		outputs1.write(com1+";LIKE3;travel;"+like3_travel); outputs1.newLine();
		outputs1.write(com1+";LIKE3;fashion;"+like3_fashion); outputs1.newLine();
		outputs1.write(com1+";LIKE3;cars;"+like3_cars); outputs1.newLine();
		outputs1.write(com1+";LIKE3;jokes;"+like3_jokes); outputs1.newLine();
		outputs1.write(com1+";LIKE3;technology;"+like3_technology); outputs1.newLine();
		outputs1.write(com1+";LIKE3;watch;"+like3_watch); outputs1.newLine();
		outputs1.write(com1+";LIKE3;jewellery;"+like3_jewellery); outputs1.newLine();
		outputs1.write(com1+";LIKE3;dance;"+like3_dance); outputs1.newLine();
		outputs1.write(com1+";LIKE3;physical fitness;"+like3_physicalfitness); outputs1.newLine();
		outputs1.write(com1+";LIKE3;architecture;"+like3_architecture); outputs1.newLine();
		outputs1.write(com1+";LIKE3;interior design;"+like3_interiordesign); outputs1.newLine();
		outputs1.write(com1+";LIKE3;culture;"+like3_culture); outputs1.newLine();
		outputs1.flush();
...
public static int leer_datos_de_casos(String nomFixterIn1, String nomFixterIn2, 
		...
		int user2, int num_values) throws Exception
{
		...
		int maxid=0;
			...
			try{
				...
				else
				{
					...
					if(configuration.getMode()=="sv") {
						genPublicationsSV.main(null, configuration); //static version
					}
					else if (configuration.getMode()=="dv"){
						genPublicationsDV.main(null, configuration); //Versi�n din�mica
					}
					//FIN STEP 4 PAU
				...
				ioe.printStackTrace();
				System.out.println("\nHa ocurrido un problema al leer el fichero");
			}
