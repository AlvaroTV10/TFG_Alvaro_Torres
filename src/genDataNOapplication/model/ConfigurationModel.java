...
public class ConfigurationModel {
	...
	//List of rates that every emotion gets
	private List<Double> emotions_rate;
	/**
	...
	//Emotions
	public void setEmotionsList(List<Double> emotionsList) {this.emotions_rate = emotionsList;}
	public List<Double> getEmotionsList() {return this.emotions_rate;}
	...
	public int getEngagementThreshold() {
		return engagementThreshold;
	}

	public void setEngagementThreshold(int engagementThreshold) {
