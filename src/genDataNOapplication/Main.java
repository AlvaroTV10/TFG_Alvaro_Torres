...
public class Main extends Application {
	...
	public void start(Stage primaryStage) {
		...
		File file = new File("./config/newDefaultConfig.xml");
	...
	public void runCustomSettings() {
		try {
			...
			controller.startApplication("dv"); //PAU
	...
	public void showStatisticsPublicationsPage() {
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(Main.class.getResource("view/StatisticsPagePublications.fxml"));
			Node statisticsPublicationsPage = (Node) loader.load();
		
			rootLayout.setCenter(statisticsPublicationsPage);
			
			StatisticsPagePublicationsController controller = loader.getController();
			controller.setMainApp(this);
			controller.setConfiguration(configuration);
